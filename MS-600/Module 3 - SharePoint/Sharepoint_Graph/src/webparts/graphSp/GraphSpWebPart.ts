...
import styles from './GraphSpWebPart.module.scss';
import * as strings from 'GraphSpWebPartStrings';
...
export interface IGraphSpWebPartProps {
  description: string;
}

export default class GraphSpWebPart extends BaseClientSideWebPart < IGraphSpWebPartProps > {
